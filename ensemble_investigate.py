...
_CHECKPOINT_PATHS_RGB = [
        [os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-20'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-22'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-24'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-26'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-28'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-30'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-32'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-34'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-36'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-38'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-40'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-42'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-44'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-46'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-48'),
         os.path.join('output', 'finetune-clipped_data-rgb-12', 'clipped_data_rgb-50')]
]
_CHECKPOINT_PATHS_FLOW = [
        [os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-20'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-22'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-24'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-26'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-28'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-30'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-32'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-34'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-36'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-38'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-40'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-42'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-44'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-46'),
         os.path.join('output', 'finetune-clipped_data-flow-12', 'clipped_data_flow-48'),
...
def main(dataset, mode, split):
    ...
    if mode in ['rgb']:
        rgb_saver.restore(sess1, _CHECKPOINT_PATHS_RGB[0][0])
        rgb_saver.restore(sess2, _CHECKPOINT_PATHS_RGB[0][1])
        rgb_saver.restore(sess3, _CHECKPOINT_PATHS_RGB[0][2])
        rgb_saver.restore(sess4, _CHECKPOINT_PATHS_RGB[0][3])
        rgb_saver.restore(sess5, _CHECKPOINT_PATHS_RGB[0][4])
        rgb_saver.restore(sess6, _CHECKPOINT_PATHS_RGB[0][5])
        rgb_saver.restore(sess7, _CHECKPOINT_PATHS_RGB[0][6])
        rgb_saver.restore(sess8, _CHECKPOINT_PATHS_RGB[0][7])
        rgb_saver.restore(sess9, _CHECKPOINT_PATHS_RGB[0][8])
        rgb_saver.restore(sess10, _CHECKPOINT_PATHS_RGB[0][9])
        rgb_saver.restore(sess11, _CHECKPOINT_PATHS_RGB[0][10])
        rgb_saver.restore(sess12, _CHECKPOINT_PATHS_RGB[0][11])
        rgb_saver.restore(sess13, _CHECKPOINT_PATHS_RGB[0][12])
        rgb_saver.restore(sess14, _CHECKPOINT_PATHS_RGB[0][13])
        rgb_saver.restore(sess15, _CHECKPOINT_PATHS_RGB[0][14])
        rgb_saver.restore(sess16, _CHECKPOINT_PATHS_RGB[0][15])
    if mode in ['flow']:
        flow_saver.restore(sess1, _CHECKPOINT_PATHS_FLOW[0][0])
        flow_saver.restore(sess2, _CHECKPOINT_PATHS_FLOW[0][1])
        flow_saver.restore(sess3, _CHECKPOINT_PATHS_FLOW[0][2])
        flow_saver.restore(sess4, _CHECKPOINT_PATHS_FLOW[0][3])
        flow_saver.restore(sess5, _CHECKPOINT_PATHS_FLOW[0][4])
        flow_saver.restore(sess6, _CHECKPOINT_PATHS_FLOW[0][5])
        flow_saver.restore(sess7, _CHECKPOINT_PATHS_FLOW[0][6])
        flow_saver.restore(sess8, _CHECKPOINT_PATHS_FLOW[0][7])
        flow_saver.restore(sess9, _CHECKPOINT_PATHS_FLOW[0][8])
        flow_saver.restore(sess10, _CHECKPOINT_PATHS_FLOW[0][9])
        flow_saver.restore(sess11, _CHECKPOINT_PATHS_FLOW[0][10])
        flow_saver.restore(sess12, _CHECKPOINT_PATHS_FLOW[0][11])
        flow_saver.restore(sess13, _CHECKPOINT_PATHS_FLOW[0][12])
        flow_saver.restore(sess14, _CHECKPOINT_PATHS_FLOW[0][13])
        flow_saver.restore(sess15, _CHECKPOINT_PATHS_FLOW[0][14])
        flow_saver.restore(sess16, _CHECKPOINT_PATHS_FLOW[0][15])
    ...
    if mode in ['rgb']:
        for variable in tf.global_variables():
            ...
            if tmp[0] == _SCOPE['rgb']:
                print(variable.name)
                assign_op = tf.assign(variable, tf.divide(tf.add_n([sess1.run(variable.name), sess2.run(variable.name), sess3.run(variable.name), sess4.run(variable.name), sess5.run(variable.name), sess6.run(variable.name), sess7.run(variable.name), sess8.run(variable.name), sess9.run(variable.name), sess10.run(variable.name), sess11.run(variable.name), sess12.run(variable.name), sess13.run(variable.name), sess14.run(variable.name), sess15.run(variable.name), sess16.run(variable.name)]), 16))
                sess.run(assign_op)
    ...
    saver.save(sess, os.path.join(log_dir, dataset+'_'+mode), global_step=16)
